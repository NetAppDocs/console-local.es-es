...
La implementación local de la consola agrupa las alertas de los clústeres ONTAP y las operaciones de Backup and Recovery en una única vista. La página de alertas incluye un panel, una lista de alertas y una vista que muestra las alertas de todos los sistemas de la organización. Cada alerta identifica el sistema afectado, su gravedad y su área de impacto.
...
* *Gravedad* indica urgencia, de mayor a menor: Crítico, Advertencia e Informativo.
* *Área de impacto* identifica el ámbito afectado: disponibilidad, capacidad, configuración, rendimiento, protección y seguridad.
...
* *Las alertas de ONTAP* provienen del Sistema de Gestión de Eventos (EMS) de ONTAP en los clústeres locales que Console local deployment ha descubierto, así como de las métricas de supervisión recopiladas de ONTAP. link:https://docs.netapp.com/us-en/ontap-ems/acp-auto-events.html["Obtén más información sobre el ONTAP EMS y las alertas disponibles."^]
...
* Se aplica a todos los sistemas de la organización.
...
* link:task-alert-rules-manage.html["Crear y gestionar reglas de notificación"]
