...
.Pasos
. Comprueba que el botón *Asistente de la consola* aparece en el panel de control de implementación local de la NetApp Console.
. Abre el asistente en modo *Solo lectura* y ejecuta una consulta básica.
. Abre el asistente en modo *lectura/escritura* y confirma que las acciones que modifican el almacenamiento requieran la confirmación del usuario antes de ejecutarse.
