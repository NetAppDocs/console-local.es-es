...
link:concept-folders-fleets-overview.html["Obtén más información sobre las carpetas y las flotas en el despliegue local de NetApp Console"].
...
* link:concept-storage-classes.html["Obtén información sobre las clases de almacenamiento y las políticas en el despliegue local de NetApp Console"].
* link:task-iam-manage-folders-fleets.html["Aprende a crear y gestionar flotas"].
