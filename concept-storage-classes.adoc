...
Para obtener más información sobre cómo organizar flotas, consulta link:concept-manage-storage.html["Conoce la gestión de flotas en la implementación local de NetApp Console"].
...
* Para comprender la organización de una flota, consulta link:concept-manage-storage.html["Conoce la gestión de flotas en la implementación local de NetApp Console"].
* Para crear políticas y clases de almacenamiento, consulta link:task-storage-class-manage.html["Gestiona clases y políticas de almacenamiento"].
...
* Para analizar y corregir la deriva, consulta link:task-storage-class-drift-remediate.html["Corrige la desviación de la clase de almacenamiento"]
