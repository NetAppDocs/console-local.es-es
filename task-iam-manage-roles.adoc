...
Si necesitas añadir un nuevo miembro y asignarle su primer rol, consulta link:task-iam-manage-members-permissions.html#add-members["Agregar miembros y asignar roles"].
