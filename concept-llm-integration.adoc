...
summary: Descubre cómo el despliegue local de NetApp Console se integra con OpenAI y los modelos compatibles con OpenAI, incluidas las decisiones de proveedor, proxy y seguridad. 
---
