...
* Para enviar notificaciones por correo electrónico, el administrador de tu organización debe configurar un servidor de correo electrónico en la implementación local de la Console. Para enviar notificaciones a un sistema externo, el administrador de tu organización debe configurar un webhook. link:task-console-configure-notifications-delivery.html["Descubre cómo configurar los webhooks"].
