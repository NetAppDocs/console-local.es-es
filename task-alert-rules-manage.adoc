...
.Pasos
. En el menú de navegación de la izquierda, selecciona *Salud > Alertas*.
. Selecciona *Configuración de notificaciones* y, a continuación, selecciona *Agregar regla*.
