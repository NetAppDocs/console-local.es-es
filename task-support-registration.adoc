...
summary: Antes de que puedas abrir un caso de soporte con el soporte técnico de NetApp, necesitas añadir una cuenta de NetApp Support Site a la implementación local de NetApp Console y luego registrarte para soporte. 
---
