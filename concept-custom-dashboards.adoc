...
Para consultar el catálogo completo de tarjetas y métricas predefinidas, consulta link:reference-dashboard-card-templates.html["Conoce las tarjetas personalizadas del panel y las métricas en la implementación local de NetApp Console"].
