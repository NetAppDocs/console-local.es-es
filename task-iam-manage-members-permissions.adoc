...
NOTE: Los enlaces de invitación para usuarios locales son de un solo uso y caducan a los 7 días. Si un enlace caduca antes de que el usuario complete la configuración, elimina al usuario y añádelo de nuevo para enviar un nuevo enlace de invitación.
