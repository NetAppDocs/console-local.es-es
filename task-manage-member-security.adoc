...
Renueva las credenciales de la cuenta de servicio cuando cambien los requisitos de seguridad, invalidando los secretos anteriores y manteniendo el acceso controlado a la API.
