...
summary: Si eres usuario de VMware, puedes usar un OVA para instalar un agente de Console en tu vCenter. La descarga del OVA o la URL están disponibles a través del despliegue local de NetApp Console. 
---
